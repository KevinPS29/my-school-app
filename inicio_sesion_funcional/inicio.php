...
<html lang="en">
  ...
  <body class="container">
    ...
    <div class="bordesuperior">
      ...
      <div>
        <button type="button" onclick="window.location.href='/my_school_app/inicio_sesion_funcional/index.php'" class="inicio_sesion btn btn-primary fw-medium">Iniciar sesion</button>
      </div>
    </div>
